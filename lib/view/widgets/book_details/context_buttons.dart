...
import 'package:shenku/logic/cubit/book_details_cubit.dart';
import 'package:shenku/logic/cubit/storage_cubit.dart';

import 'context_button/context_buton.dart';

class DetailsViewContextButtons extends StatelessWidget {
  final BuildContext context;
  final BookDetailsState state;
  const DetailsViewContextButtons(this.state, {Key? key, required this.context})
      : super(key: key);

  @override
  Widget build(_) {
    bool isInLibrary = context.appData.library.contains(state.book);
